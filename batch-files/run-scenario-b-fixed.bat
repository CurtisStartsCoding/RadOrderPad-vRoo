@echo off
echo Running RadOrderPad Scenario B with Fixed Helpers
echo ================================================
...
copy tests\e2e\test-helpers-fixed-b.js tests\e2e\test-helpers.js

REM Run Scenario B
echo Starting Scenario B test at %time%
set NODE_PATH=%CD%\node_modules
node tests\e2e\scenario-b-validation-override.js
...
if %EXIT_CODE% EQU 0 (
  echo.
  echo Scenario B completed successfully!
) else (
  echo.
