...
REM Usage: update-trial-user-max-validations.bat [userId] [newMaxValidations]
...
REM EC2 instance details - using public IP address
set EC2_HOST=ubuntu@68.6.95.186
