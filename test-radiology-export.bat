...
set ORDER_ID=5
set AUTH_TOKEN=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjEsIm9yZ0lkIjoxLCJyb2xlIjoic2NoZWR1bGVyIiwiZW1haWwiOiJ0ZXN0LnNjaGVkdWxlckBleGFtcGxlLmNvbSIsImlhdCI6MTc0NTE5NDQwNiwiZXhwIjoxNzQ1MjgwODA2fQ.1iboUbnhQiblGsbG9Yx_yNX4UE_bu0CS_oDKL2SKCMQ
