@echo off
echo Running RadOrderPad Scenario F with Fixed Scenario
echo ================================================
...
echo Starting Scenario F test at %time%
...
if %EXIT_CODE% EQU 0 (
  echo.
  echo Scenario F passed successfully!
) else (
  echo.
  echo Scenario F failed. Check the logs for details.
)
