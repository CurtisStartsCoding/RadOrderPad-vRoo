@echo off
echo Running RadOrderPad Scenario G with Fixed Scenario
echo ================================================
...
echo Starting Scenario G test at %time%
...
if %EXIT_CODE% EQU 0 (
  echo.
  echo Scenario G passed successfully!
) else (
  echo.
  echo Scenario G failed. Check the logs for details.
)
