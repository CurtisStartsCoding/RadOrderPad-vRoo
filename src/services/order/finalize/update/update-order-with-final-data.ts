...
export async function updateOrderWithFinalData(
  ...
  await client.query(
    ...
    [
      ...
      Array.isArray(payload.finalICD10Codes) ? payload.finalICD10Codes.join(',') : payload.finalICD10Codes,
      Array.isArray(payload.finalICD10CodeDescriptions) ? payload.finalICD10CodeDescriptions.join(';') : payload.finalICD10CodeDescriptions,
