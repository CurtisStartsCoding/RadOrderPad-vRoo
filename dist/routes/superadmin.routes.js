...
import { listAllOrganizationsController, getOrganizationByIdController, listAllUsersController, getUserByIdController, prompts, logs } from '../controllers/superadmin';
const router = Router();
