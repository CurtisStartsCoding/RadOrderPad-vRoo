 ...
 */
export async function fetchValidationAttempts(orderId) {
    const validationAttemptsResult = await queryPhiDb(`SELECT va.id, va.attempt_number, va.validation_outcome, va.generated_compliance_score,
            va.created_at
