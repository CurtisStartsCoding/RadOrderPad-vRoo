 ...
 */
export async function handleSignatureUpload(orderId, userId) {
    ...
    const result = await getUploadUrl(contentType, fileName, contentType, orderId, undefined, // patientId will be looked up by the service
    documentType);
