-- Migration: Update prompt template field names to match backend expectations
-- Date: 2025-04-15

-- Connect to the radorder_main database
\c radorder_main;

-- Update the existing prompt template to use the correct field names
...
-- If no rows were updated, it means the template doesn't exist yet, so insert it
