-- Insert comprehensive validation prompt template into prompt_templates table
...
-- Then insert the new comprehensive prompt
...
Should be classified as "needs_clarification" with specific guidance on improving the primary diagnosis code and supporting documentation. Under no circumstances should borderline cases be approved with mere suggestions.
